...
Review: ReviewType[]; // ⬅️ Sudah lengkap dan jelas
...
✕
              ...
              <div className="grid gap-5">
                ...
                <div className="flex items-center gap-2 bg-white border border-gray-300 rounded-xl shadow-sm w-fit px-2 py-1">
                  <button
                    className="w-8 h-8 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition duration-200 shadow-inner"
                    aria-label="Kurangi"
                  >
                    –
                  </button>
            ...
            <div className="bg-white w-[50vh] p-4 rounded shadow-lg relative border h-full">
              <ReviewForm />
            </div>
          </div>
        </div>
